...
public class MapGrid {
    ...
    final int width, height; //tamanho e altura do mapa
    final char[][] tiles; //cada local do mapa como exemplo: deserto, cidade, etc...
    final boolean[][] visited; // marca se o jogador já visitou aquele local

    //faz um objeto para armazenar cada local e também preencher-los 
    MapGrid(int w , int h, char defaultTitle){
